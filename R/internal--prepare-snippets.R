...
merge_and_update_snippets <- function(type, snippets_dir = "snippets/") {
  ...
  # Note: Package-based installation is no longer supported
  # The module system now only supports local and URL sources
  # This function is primarily for internal development/testing
